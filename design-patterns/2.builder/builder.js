 ...
 * 2. Builder
 * 
 * Builder is implemeted in objects that require a large
 * procces to be initialized. It opt for piecewise construction
 * and provides an API for constructing step by step.
 * 
 */
