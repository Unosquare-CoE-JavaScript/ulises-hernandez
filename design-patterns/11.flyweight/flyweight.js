 ...
 * 11. Flyweight
 * 
 * The Flyweight pattern is a space optmization technique
 * that allow us to use less memory by storing externally
 * the data associated with similar objects.
 * It stores common data externally and specifies and index
 * or a reference into the external data store.
 */
