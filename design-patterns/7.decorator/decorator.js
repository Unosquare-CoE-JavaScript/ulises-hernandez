 ...
 * 7. Decorator
 * 
 * Decorators facilitate the addition of behaviors to
 * indidual objects without inherting from them.
 * It keeps the reference to the decorated object(s)
 * and it may or may not forward calls to the underlying object.
 * 
 */
